...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Concert+One|Galada&display=swap" rel="stylesheet">

  <link rel="stylesheet" href="css/main.css">
  <link rel="stylesheet" href="css/mobile.css">
  
  <title>BLESS'U CAKE | PRODUCTS</title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-4">
          <img class="img-responsive wow zoomInLeft" src="./imgs/c10.jpg" alt="">
        </div>
      </div>
        <div class="row pt-3">
          <div class="col-lg-5 col-md-4">
            <img class="img-responsive wow zoomInRight" src="./imgs/c12.jpg" alt="">
          </div>
          <div class="col-lg-4 col-md-5 ">
            <h2>Wedding Cake</h2>
          </div>
        ...
        <div class="row pt-3 pb-5">
          ...
          <div class="col-lg-8 col-md-7">
            <img class="img-responsive wow zoomInRight" data-wow-delay="0.6" src="./imgs/c6.jpg" alt="">
          </div>
        </div>
    </div>
  </section>
